  ...
  return (
    <>
      <section id='home' className='mid:px-12 mid:py-16 flex flex-col gap-4 px-6 py-10'>
        <motion.div {...fadeUp} className='rounded-2xl bg-slate-800/30 backdrop-blur-sm border border-slate-700/40 p-6 md:p-10'>
      ...
      <section id='contact' className='mid:px-12 mid:py-16 flex flex-col gap-4 px-6 py-10 pb-96 mid:pb-[64rem]'>
        <motion.div {...fadeUp} className='rounded-2xl bg-slate-800/30 backdrop-blur-sm border border-slate-700/40 p-6 md:p-10'>
          <div className='flex flex-col md:flex-row gap-8'>
            <div className='flex flex-1 flex-col gap-5 overflow-hidden'>
              <div>
