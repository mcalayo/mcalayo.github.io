...
export default async function Page() {
  return (
    <section className='mid:p-12 flex flex-col gap-4 p-6'>
      <div className='flex h-[470px] linkedin:h-[453px] flex-col justify-between gap-12 rounded-2xl bg-sky-300/20 p-2 md:flex-row'>
        <div className='flex h-full w-full flex-col overflow-hidden p-4'>
          ...
          <p className="scrollbar overflow-auto">
            ...
            <br /><br />
            {`Let's `}<a className='text-blue-500 underline' href='/contact'>connect</a> {`and create something amazing together!`}
          </p>
        </div>
